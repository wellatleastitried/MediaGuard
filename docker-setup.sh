...
echo ""
echo "Next steps:"
echo "1. Review .env, secrets/server.env, and secrets/client.env"
echo "2. Start services with: docker compose up --build -d"
echo "3. Open MediaGuard Client at: http://localhost:$client_port"
